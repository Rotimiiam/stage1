...
if ($slack_name && $track) {
    ...
    $github_file_url = "https://github.com/Rotimiiam/stage1/blob/main/api.php"; // Replace with your GitHub file URL
    $github_repo_url = "https://github.com/Rotimiiam/stage1"; // Replace with your GitHub repo URL
